        ...
        <div class="leftDiv" style="background:url(images/1001.jpg)">
            ...
            <div class="centerDiv">  
                   <div class="contentDiv">
                    <h3 class="text-danger text-center"  style="margin-bottom: 15px">管理专业</h3>
                    <div class="text-center">
                           <form action="${pageContext.request.contextPath}/admin/adminMaj"  method="post">
