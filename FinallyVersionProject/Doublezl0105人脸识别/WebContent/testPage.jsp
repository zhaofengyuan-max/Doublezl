...
<!-- 					         <input type="submit" value="提交" class="btn btn-small btn-danger"> -->
              <label for="batch">请选择年份：</label>
		            <select name="batchName" id="batch">
		                <option value="16软件（Java）02">16软件（Java）02</option>
		                <option value="16软件（Java）03">16软件（Java）03</option>
		                <option value="16软件（Java）04">16软件（Java）04</option>
		            </select>
              </form>
           </div>
