                            ...
                            <div class="card ">
                                ...
                                <div class="content">
                                    <div class="form-group">
                                        <label>学号</label><span id="stuNoError" style="color:red"></span>
                                        <input type="text" name="stuNo" id="stuNo" placeholder="Number" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>密码</label> <span id="passwordError" style="color:red"></span>
