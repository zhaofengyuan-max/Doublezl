...
<head>
     ...
     <script language="javascript">
		function check1()
		{                                                                                         
		     if(document.ThisForm.stuno.value=="")
			 {
			 	alert("请输入账号");
				document.ThisForm.stuno.focus();
				return false;
			 }
			 if(document.ThisForm.stupwd.value=="")
			 {
			 	alert("请输入密码");    
    ...
    <body>
        <div id="index_all">
            <div class="header"> 
               <div class="logo"><a href="#"><img src="" width="386" height="79" alt="" class="png" /></a></div>
               <div class="search">
               ...
               <div class="nav-bar">
                    <ul>
                        <li><a href="index.xhtml" class="first current" >首页</a></li>
                            ...
                            <li><a href="adminlogin.xhtml" class="three">网站管理</a></li>
				      ...
				      <table border="0" cellSpacing="0" cellPadding="0" width="100%">
				          ...
				          <tr>
					          <td style="HEIGHT: 30px;padding-left:25px">
					              ...
					              <input type="text" name="stuNo" style="width: 110px;padding:2px;">
					          </td>
				          </tr>
				          <tr>
					          <td style="HEIGHT: 30px;padding-left:25px">
					              <span style="font-family: 微软雅黑;font-size: 18px;">密码：</span>
					              <input type="password" name="stuPwd" style="width:110px;padding:2px;">
					          </td>
				          </tr>
				          <tr>
				          	  <td style="HEIGHT:30px ;padding-left:7px"> 
				          	  		<span style="font-family: 微软雅黑;font-size:18px;">验证码：</span>
				          	  	    <input id="authCode" name="authCode" type="text" style="width:110px;padding:2px;"/>
       									<img src="authCode.do 

" id="codeImage" onclick="changeCode()" title="图片看不清？点击重新得到验证码" style="cursor:pointer;"/>
            ...
            <div class="link">
                ...
                <select name="select"  id="select"  onchange='link(this);'>
                    ...
                    <option value="http://www.qdu.edu.cn" onclick="_blank">青岛大学</option>
                    <option value="http://www.moe.gov.cn" onclick="_blank">教育部</option>
                    <option value="http://yz.chsi.com.cn" onclick="_blank">全国研招网</option>
                 </select>
            </div>
        </div>
        </div>
