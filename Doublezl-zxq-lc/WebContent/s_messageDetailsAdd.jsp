        ...
        <div class="middleDiv" >
            ...
            <div class="centerDiv">
                   <div class="contentDiv">
                    <div class=" container">  
                    <h3 class="text-danger text-center"  style="margin-bottom: 5px">添加留言</h3>
                     <form action="${pageContext.request.contextPath}/message/addMessage" name="formAdd"  method="post"  id="fm">
